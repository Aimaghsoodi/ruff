...
"#,
    ...
    impl CursorTest {
        ...
        fn supertypes(&self) -> Vec<TypeHierarchyItem> {
            ...
            type_hierarchy_supertypes(&self.db, item.file, item.selection_range.range().start())
        }
        ...
        fn subtypes(&self) -> Vec<TypeHierarchyItem> {
            ...
            type_hierarchy_subtypes(&self.db, item.file, item.selection_range.range().start())
        }
    }
}
